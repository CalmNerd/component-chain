			...
			<div className='mx-auto max-w-full z-50 relative'>
				<div className='mx-auto max-w-4xl text-center'>
					...
					<div className='mt-8 sm:mt-10 flex flex-row items-center justify-center gap-4 sm:gap-x-6 z-50 px-4 sm:px-0'>
						<Button
							size='lg'
							className='sm:w-auto shadow-inner shadow-black  px-6 sm:px-8 py-3 sm:py-4 h-10 sm:h-11 text-sm sm:text-base text-black hover:bg-gray-100 focus-visible:outline-offset-2 focus-visible:outline-gray-500 transition-colors text-shadow-xs'
						>
						...
						<Button
							...
							size='lg'
							asChild
							className='sm:w-auto text-sm sm:text-base font-medium leading-6 text-foreground hover:text-muted-foreground transition-colors h-10 sm:h-11 group'
						>
							<Link
							...
							>
								...
								<span className='xs:hidden'>View on GitHub</span>
